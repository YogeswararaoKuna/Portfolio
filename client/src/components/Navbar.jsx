      ...
      <div className="flex items-center justify-between px-4 md:px-10 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex gap-4 text-lg">
            ...
            <a href="https://github.com/YogeswararaoKuna" target="_blank">
              <FaGithub className="text-black dark:text-white hover:scale-110 transition" />
            </a>

            <a href="https://www.linkedin.com/in/yogeswara-rao-kuna-a166802b9" target="_blank">
              <FaLinkedin className="text-blue-600 hover:scale-110 transition" />
            </a>

            <a href="https://leetcode.com/u/kuna_yogeswararao/" target="_blank">
              <SiLeetcode className="text-orange-500 hover:scale-110 transition" />
            </a>

            <a href="https://youtube.com/@yogidhoni" target="_blank">
